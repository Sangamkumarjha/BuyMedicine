    ...
    <div>
      <header className="bg-blue-500 text-white py-4">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold">Summer Essential Products</h1>
          <nav>
      ...
      <main className="container mx-auto my-8">
        <section id="home" className="my-16 text-center">
          <h2 className="text-4xl font-bold">Welcome to Summer Essential Products</h2>
          <p className="mt-4 text-lg text-gray-700">Your one-stop shop for the best  summer essential items.</p>
        </section>
      ...
      <footer className="bg-gray-800 text-white py-4">
        <div className="container mx-auto text-center">
          <p>&copy; 2024 Summer Essential Products. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
